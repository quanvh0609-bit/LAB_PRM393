                        ...
                        GestureDetector(
                          onTap: () {
                            ref
                                ...
                                .state++;
                            location.countStar = ref.read(starProvider(index));
                          },
                          child: Row(
                            children: [
                        ...
                        TextButton(
                          onPressed: () {
                            Navigator.push(
                              ...
                              ref.read(starProvider(index).notifier).state = location.countStar;
                            });
                          },
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        _ActionItem(
                          ...
                          label: 'ROUTE',
                          onTap: () => ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(content: Text('Opening route to ${location.address}...')),
                          ),
                        ),
                        _ActionItem(
                          icon: Icons.share,
                          label: 'SHARE',
                          onTap: () => ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(content: Text('Sharing ${location.name}...')),
                          ),
                        ),
                      ],
                    ),
